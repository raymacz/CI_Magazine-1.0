...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/CI_proj1/CI_lynda/css/bootstrap.min.css">
        <style>
            body {
                padding-top: 60px;
                padding-bottom: 40px;
        ...
        <link rel="stylesheet" href="/CI_proj1/CI_lynda/css/bootstrap-responsive.min.css">
        <link rel="stylesheet" href="/CI_proj1/CI_lynda/css/main.css">

        <script src="/CI_proj1/CI_lynda/js/vendor/modernizr-2.6.2.min.js"></script>
    </head>
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <a class="brand" href="/CI_proj1/CI_lynda">Magazine Collection</a>
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                          <?php
                            foreach ($menu_items as $item => $item_data) {
                              echo '<li' . ($item == $menu_current ? ' class="active"' : '') . '>';
                              echo '<a href="/CI_proj1/CI_lynda/index.php/magazine/' . $item . '" title="' . $item_data['desc'] . '">' . $item_data['label'] . '</a>';
                              echo '</li>';
                            }
                          ?>
                        </ul>
